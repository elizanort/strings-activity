...
// Note that the length of the string should be maxLength including the ellipsis.  This means you'll have to subtract the length of the ellipsis fom the maxLength to know how many characters there should be.
